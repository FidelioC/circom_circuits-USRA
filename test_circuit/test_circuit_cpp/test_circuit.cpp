...
// load src
Fr_mul(&expaux[1],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 2]); // line circom 9
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 3]); // line circom 9
// end load src
